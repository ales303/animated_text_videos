...
def blast_off(stock_symbol, specific_date_to_process=None, interval="1m", start_date=None):
    now = datetime.now()
    ...
    data = yf.download(f"{stock_symbol}", start=starting_date, interval=interval)
